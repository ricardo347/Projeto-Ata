        ...
        EnsureScriptFunc("sp.core.js", "SP.SlapiInternal", function() {
            ...
            if (!IsNullOrUndefined(a)) {
                ...
                if (typeof PerformanceLogger.ControlPerformanceData == "function") {
                    a.AddExpectedControl(g);
                    var d = new PerformanceLogger.ControlPerformanceData(g, i, Number(c), a.ComputeControlRenderTime, a.CheckControlTimeRequiredDataAvailable);
...
function PerformanceLogger_module_def() {
    ...
    PerformanceLogger.Logger = function(f) {
        ...
        var d = new Array(0),
            ...
            n = false,
            b = this;
        if (IsNullOrUndefined(f)) f = CacheLogger.GetLogger();
        ...
        this.WriteServerSideLatency = function(c, a) {
            if (!IsNullOrUndefined(b.PerformanceData) && !j) {
        ...
        function G() {
            var f = true;
            if (IsNullOrUndefined(e) || IsNullOrUndefined(d)) return false;
        ...
        this.WriteScenarioId = function(a, c) {
            if (k && !c) return;
            if (IsNullOrUndefined(a)) return;
        ...
        function v() {
            ...
            if (IsNullOrUndefined(f)) return;
            f.WriteLog("RUMOne", b.GetPerformanceData(), true)
        }
        ...
        function y(d, c) {
            ...
            a.Message = c;
            if (IsNullOrUndefined(f)) return;
            f.WriteLog("RUMOneErrors", a)
        }
        this.AddExpectedControl = function(a) {
            e.indexOf(a) === -1 && e.push(a)
        };
        this.CheckControlTimeRequiredDataAvailable = function(a, f) {
        ...
        this.ComputeControlRenderTime = function(b, a) {
