function $_global_clientpeoplepicker() {
    ...
    SPClientPeoplePicker.prototype = {
        ...
        OnControlResolvedUserChanged: function () {
            a:; this.SaveAllUserKeysToHiddenInput(); this.ValidateCurrentState(); this.OnUserResolvedClientScript != null && this.OnUserResolvedClientScript(this.TopLevelElementId, this.GetAllUserInfo())
        },
    ...
    SPClientPeoplePicker.AugmentEntitySuggestions = function (a, c, i) {
        ...
        for (var f = [], h = c.length, e = 0; e < h; e++) {
            ...
            if (i && (d = a.CurrentLocalSuggestionsDict[g.toLowerCase()]) != null) {
                if (typeof ExpFlighting != "undefined" && ExpFlighting.UseGU30()) {
    ...
    SPClientPeoplePickerProcessedUser.prototype = {
        ...
        UpdateResolvedUser: function (a, c) {
            ...
            b.title = b.innerHTML = this.DisplayName;
        ...
        BuildUserHTML: function () {
            a:;
            var a = [],
                c = SPClientPeoplePickerProcessedUser.BuildUserPresenceHtml(this.PresenceElementId, this.SIPAddress, this.ResolvedUser); a.push('<span data-sp-peoplePickerProcessedUser="true" id="'); a.push(STSHtmlEncode(this.UserContainerElementId)); a.push('" ResolvedUser="'); a.push(this.ResolvedUser ? "true" : "false"); a.push('" SID="'); a.push(STSHtmlEncode(this.SID)); a.push('" class="sp-peoplepicker-userSpan">'); a.push('<span class="sp-peoplepicker-userPresence" id="'); a.push(STSHtmlEncode(this.PresenceElementId)); a.push('">'); a.push(c); a.push("</span>"); a.push('<span class="'); a.push(this.ResolvedUser ? "ms-entity-resolved" : "ms-entity-unresolved"); a.push('" id="'); a.push(STSHtmlEncode(this.DisplayElementId)); a.push('" title="'); a.push(STSHtmlEncode(this.DisplayName)); a.push('">');
            ...
            var b = StBuildParam(Strings.STS.L_SPClientDeleteProcessedUserAltText, this.DisplayName); a.push('<a class="sp-peoplepicker-delImage" title="'); a.push(STSHtmlEncode(b)); a.push('" id="'); a.push(STSHtmlEncode(this.DeleteUserElementId)); a.push('" onkeydown="SPClientPeoplePickerProcessedUser.HandleDeleteProcessedUserKey(event); return true;"'); a.push(' href="#" onclick="SPClientPeoplePickerProcessedUser.DeleteProcessedUser(this.parentNode); return false;" >'); a.push("x</a>"); a.push("</span>");
            return a.join("")
        },
