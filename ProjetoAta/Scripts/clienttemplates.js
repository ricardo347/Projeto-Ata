function $_global_clienttemplates() {
    ...
    if (window.ClientPivotControl == null) {
        ...
        a.prototype = {
            ...
            RenderSurfacedOption: function (c) {
                ...
                a.push('" onclick="');
                !(window.OffSwitch == null || OffSwitch.IsActive("FD8DB143-ED17-47C8-AF2F-46BA4407795B")) && a.push(Encoding.HtmlEncode('SP.QoS.WriteUserEngagement("ClientPivot_ViewSelected");'));
    ...
    if (typeof window.ComputedFieldWorker != "function") window.ComputedFieldWorker = function () {
        ...
        function c(d, b, c) {
            var g = Flighting.VariantConfiguration.IsExpFeatureClientEnabled(499),
                a = [],
                i = b.FileRef;
            if (i != null && typeof i != "undefined" && TrimSpaces(i) != "")
                if (b.FSObjType == "1")
                    ...
                    var f = (Boolean(d.RealHttpRoot) ? ListModule.Util.getHostUrl(d.HttpRoot) : "") + b.FileRef;
                    if (g) f = Encoding.HtmlEncode(f);
                    ...
                    a.push(g ? Encoding.HtmlEncode(e) : e);
                    a.push("</a>");
                    h(b, c, a)
                } else {
                a.push("<nobr>");
                a.push(g ? Encoding.HtmlEncode(b.FileLeafRef) : b.FileLeafRef);
                a.push("</nobr>")
            }
            return a.join("")
        }
        ...
        function g(c, y, b, d) {
            var a = [],
                v = Flighting.VariantConfiguration.IsExpFeatureClientEnabled(499),
                j = v ? Encoding.HtmlEncode(b.FileLeafRef) : b.FileLeafRef,
            ...
            if (m) {
                ...
                if (b["DocIcon.groupindex"]) f += b["DocIcon.groupindex"];
                    ...
                    var w = d.group1;
                    f += b[w + ".groupindex"] + b["DocIcon.groupindex2"]
                }
            }
            if (ListModule.Settings.SupportsAddToOneDrive && Boolean(IsMountPoint(b))) {
                ...
                if (SupportAjaxFolderNav(c)) {
                    var x = c.clvp != null ? c.clvp.WebPartId() : "";
                ...
                if (typeof b.IconOverlay == "undefined" || b.IconOverlay == "") {
                    var g = false,
                        ...
                        k = typeof b._ComplianceFlags !== "undefined" && b._ComplianceFlags != null && (b._ComplianceFlags & 1) == 1;
                    if (IsFileHandlerForAllNonOfficeFilesSupported()) {
        ...
        return {
            ...
            _IsRecord: function (d, e, a) {
                var b = typeof a._ComplianceFlags !== "undefined" && a._ComplianceFlags != null && (a._ComplianceFlags & 1) == 1;
    ...
    getDocumentIconAbsoluteUrl = function (a, d, e) {
        var i = a["HTML_x0020_File_x0020_Type.File_x0020_Type.mapico"] == "",
            b;
        if (typeof d === "undefined" || d === 16) b = "";
        else if (i) b = String(d);
        else if (d === 32) b = "lg_";
        else b = String(d) + "_";
        EnsureFileLeafRefName(a);
        EnsureFileLeafRefSuffix(a);
        EnsureFileDirRef(a);
        var h = a.AlternateThumbnailUrl,
            g = ListModule.Util.isDefinedAndNotNullOrEmpty(h),
            c = a["FileLeafRef.Suffix"],
            j = a["PreviewExists.value"] == "1" && ListModule.Util.isDefinedAndNotNullOrEmpty(a["FileLeafRef.Name"]) && ListModule.Util.isDefinedAndNotNullOrEmpty(c) || a["PreviewExists.value"] == "" && e != null && e.ListTemplateType == 109,
            k = ListModule.Util.isDefinedAndNotNullOrEmpty(c) && (c == "mp3" || c == "wma" || c == "wav" || c == "oga"),
            f = typeof ctx != "undefined" ? ctx : e;
        return b != "" && (g || j) ? g ? String(h) : a.FileDirRef + "/_w/" + a["FileLeafRef.Name"] + "_" + a["FileLeafRef.Suffix"] + ".jpg" : k ? f.imagesPath + "audiopreview.png" : i ? f.imagesPath + "folder" + b + ".gif" : f.imagesPath + b + a["HTML_x0020_File_x0020_Type.File_x0020_Type.mapico"]
    };
...
function RenderHeroParameters(a) {
    ...
    } else if (b == 101 || b == 700 || b == 702 || Flighting.VariantConfiguration.IsExpFeatureClientEnabled(365) && a.listBaseType == 1 && b >= 1e4) {
    ...
    this.addNewUrl = e;
    this.largeSize = Boolean(g.InplaceSearchEnabled) || b == 700 || Boolean(window.groupContextData) && b == 101
}
...
function ReRenderHeroButton(a) {
    if (!Flighting.VariantConfiguration.IsExpFeatureClientEnabled(497)) return;
...
function EditRequiresCheckout(b, c) {
    var a = typeof b.CheckoutUser == "undefined" || b.CheckoutUser == "";
    if (!Flighting.VariantConfiguration.IsExpFeatureClientEnabled(499)) a = !a;
    return c.ForceCheckout == "1" && b.FSObjType != "1" && a ? "1" : ""
}
...
function DateTimeFieldRendererRenderField(g, h, e) {
    ...
    if (b == null) return "";
    var c = e[this.fldName + ".FriendlyDisplay"],
        a = null;
...
function RenderUserFieldWorker(renderCtx, field, listItem, listSchema) {
    ...
    function UserLinkWithSize(e) {
        ...
        if (field.HasUserLink && (Boolean(c) || lookupId != null && lookupId != "" && parseInt(lookupId) > -1)) {
            var d = "";
            if (Flighting.VariantConfiguration.IsExpFeatureClientEnabled(499) && !Boolean(listSchema.UserDispUrl) && Boolean(_spPageContextInfo) && Boolean(_spPageContextInfo.webServerRelativeUrl)) listSchema.UserDispUrl = Nav.combineUrl(_spPageContextInfo.webServerRelativeUrl, "_layouts/15/userdisp.aspx");
    ...
    function AppendUserPhotoUrl(a, f, b) {
        !(window.OffSwitch == null || OffSwitch.IsActive("4BF41ED4-46A6-4A0F-8641-2AA7AFED55D7")) && a.push(_spPageContextInfo.webServerRelativeUrl);
